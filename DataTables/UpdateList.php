                                    ...
                                    <div class="modal fade" id="UPDATEbtn" tabindex="-1" role="dialog" aria-labelledby="UPDATEbtnLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-dark">
                                                    <form action="../includes/update.proccess.php" enctype="multipart/form-data" method="POST">
                                                        <div class="input-group">
                                                            <input hidden type="text" name="ID" value="<?php echo $row['a_id']; ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                                ...
                                                                <input  type="text" name="asset_id" value="<?php echo $row['a_id']; ?>">
                                                                <button type="submit" class="btn btn-primary" name="processREQUEST">Submit</button>
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
